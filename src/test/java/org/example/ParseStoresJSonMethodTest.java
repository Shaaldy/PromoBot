...
public class ParseStoresJSonMethodTest {
    ...
    public void testFilterSorted1() {
        List<Item> expectedResults = new ArrayList<>();
        expectedResults.add(new Item("Кетчуп Махеевъ Чили 300г", "99.99", "74.99", "2023-12-12",
                "2023-12-18", "https://skidkaonline.ru/img/p/2023/12/488793/54602958-488793-ketchup-makheev-chili-300g.jpg?t=t1702350137"));
        expectedResults.add(new Item("Кетчуп Heinz итальянский 320г", "139.99", "94.99", "2023-12-12",
                "2023-12-18", "https://skidkaonline.ru/img/p/2023/12/488793/54602960-488793-ketchup-heinz-italyanskijj-320g.jpg?t=t1702350137"));
        expectedResults.add(new Item("Кетчуп Heinz томатный 320г", "190.99", "120.99", "2023-12-12",
        ...
        List<Item> filterSortedData = fakeDataParser.filter();
    ...
    public void testFilterSorted2() {
        List<Item> expectedResults = new ArrayList<>();
        expectedResults.add(new Item("Конфеты HALLS Mini Mints со вкусом мяты 12.5г", "48.99", "39.99", "2023-12-12",
        ...
        expectedResults.add(new Item("Конфета Nuts Duo цельный фундук 66г", "91.99", "59.99", "2023-12-12",
        ...
        expectedResults.add(new Item("Конфеты Рот Фронт батончики", "799.99", "332.99", "2023-12-12",
                "2023-12-18", "https://skidkaonline.ru/img/p/2023/12/488793/54602942-488793-konfety-rot-front-batonchiki.jpg?t=t1702350136"));

        expectedResults.add(new Item("Конфеты Рот Фронт Маска", "849.99", "379.99", "2023-12-12",
                "2023-12-18", "https://skidkaonline.ru/img/p/2023/12/488793/54602943-488793-konfety-rot-front-maska.jpg?t=t1702350136"));

        expectedResults.add(new Item("Конфеты Райские Облака Суфле сливочное", "549.99", "459.99", "2023-12-12",

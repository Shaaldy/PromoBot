...
public class ParseStoresJSonMethodTest {
    String filePath = "src/main/java/org/example/FakeData/TestData.txt";
    ...
    public void testFilterSorted1() {
        ...
        for (int i = 0; i < filterSortedData.size(); ++i) {
            ...
            assertEquals(expectedResults.get(i).getPriceafter(), filterSortedData.get(i).getPriceafter(), 0.01);
            assertEquals(expectedResults.get(i).getPricebefore(), filterSortedData.get(i).getPricebefore(), 0.01);

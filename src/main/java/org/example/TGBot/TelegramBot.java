...
import static org.example.TGBot.Service.PaginationHandler.pagination;
import static org.example.TGBot.Service.PaginationHandler;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public UserState getUserState(Long chatId) {
        return this.userState.get(chatId);
    }

    private final String botToken;
    private final String botName;

    public void setUserData(Long chatId, UserState userData) {
        this.userState.put(chatId, userData);
    }
    ...
    private void handleCallbackQuery(CallbackQuery callbackQuery) throws IOException {
        ...
        PaginationHandler paginarionHadler = new PaginationHandler(TelegramBot.this);
        pagination(chatId, data);
    ...
    private void messageProcessing(long chatId, String messageText, Update update) throws IOException {
        ...
        if (messageText.startsWith("/")) {
            ...
            List<List<Item>> data = Service.getDataForPage(messageText);
    ...
    private void sendMessage(long chatId, String textToSend) {
        ...
        List<List<Item>> curData = userState.get(chatId).getUserData();
        int currentPage = userState.get(chatId).getUserCurrentPage();
        int currentStore = userState.get(chatId).getUserCurrentStore();
